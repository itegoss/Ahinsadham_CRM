...
class DonorVolunteer(models.Model):
    ...
    person_type = models.ForeignKey("Lookup", on_delete=models.SET_NULL, null=True, blank=True, related_name="person_type_lookup")
    donor_box = models.ForeignKey(DonationBox, on_delete=models.SET_NULL, null=True, blank=True)
    # old_box_id = models.IntegerField(blank=True, null=True)
    old_box_id = models.CharField(max_length=50,blank=True,null=True)
    ...
    id_type = models.ForeignKey("Lookup", on_delete=models.SET_NULL, null=True, blank=True, related_name="id_type_lookup")
...
class Donation(models.Model):
    ...
    donation_date = models.DateField(default=timezone.now, db_index=True)
