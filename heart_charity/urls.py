...
urlpatterns = [
    ...
    path('donations/receipt/<int:donor_id>/', views.donation_receipt_view, name='donation_receipt'),
    path('show_donationbox/', views.show_donationbox, name='show_donationbox'),
