...
urlpatterns = [
    ...
    path('donations/dan-peti/', views.danpeti_page, name='danpeti_page'),
    path('donations/donation-box/', views.donation_box_page, name='donation_box_page'),
    ...
    path("donation/summary/ajax/<int:donor_id>/",views.donation_summary_ajax,name="donation_summary_ajax"),
    path("donation-summary/<int:id>/",views.donation_summary,name="donation_summary"),
    ...
    path('add-fleet/', views.add_fleet,name="add_fleet"),
    path('add-financial-asset/', views.add_financial_asset, name="add_financial_asset"),
    path('add-expense/', views.add_expense, name="add_expense"),
    path('add-medical/', views.add_medical, name="add_medical"),
    path('add-rehabilitation/', views.add_rehabilitation, name="add_rehabilitation"),
